namespace UndoRedo.Data
{
    ...
    {
        public static bool IsBoundToDataContext(this Binding binding)
        {
            return (binding.ElementName == null && binding.RelativeSource == null) && (binding.Mode == BindingMode.Default || binding.Mode == BindingMode.TwoWay || binding.Mode == BindingMode.OneWay);
        }
        public static bool IsNotifiying(this Binding binding)
        {
            return binding.NotifyOnSourceUpdated && binding.NotifyOnTargetUpdated;
        }

        public static Binding CreateNotifying(this Binding binding, object source)
        {
